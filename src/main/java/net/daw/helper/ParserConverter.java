            ...
            if (textSplit.length != 1) {
                for (int x = 0; x < textSplit.length; x++) {
                    ...
                    if (split[0].length() >= 7 && split[0].substring(0, 7).equals("http://")) {
                        if (spl.length == 1) {
                            tag = "<a href='" + split[0] + "'>" + split[1] + "&nbsp<i class='icon-globe icon-white'></i></a>";
                        } else {
                            tag = "<a href='" + split[0] + "'>" + split[1] + "&nbsp<i class='icon-globe icon-white'></i></a>" + spl[1];
                        }
                    } else {
                        ...
                        if (spl.length == 1) {
                            tag = "<a href='Controller?" + strUrl + "&id=" + split[0] + "'>" + split[1] + "&nbsp<i class='icon-globe icon-white'></i></a>";
                        } else {
                            tag = "<a href='Controller?" + strUrl + "&id=" + split[0] + "'>" + split[1] + "&nbsp<i class='icon-globe icon-white'></i></a>" + spl[1];
                        }
                    }
