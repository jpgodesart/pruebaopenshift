 ...
 * @author rafa
 */
public class UsuproGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<UsuproBean> oUsupros = oUsuproDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oUsupros);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
