 ...
 * @author rafa
 */
public class UsutareaGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<UsutareaBean> oUsutareas = oUsutareaDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oUsutareas);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
