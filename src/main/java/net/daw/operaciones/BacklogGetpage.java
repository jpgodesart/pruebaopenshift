 ...
 * @author Edu
 */
public class BacklogGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<BacklogBean> oBacklogs = oBacklogDAO.getPage(rpp, page, alFilter, hmOrder);
            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oBacklogs);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
