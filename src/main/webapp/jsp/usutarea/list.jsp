...
<%@page import="net.daw.dao.UsutareaDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    UsutareaDao oUsutareaDao = new UsutareaDao(Conexion.getConection());
    ArrayList<String> alColumnsNames = (ArrayList<String>) oUsutareaDao.getColumnsNames();
    Iterator<String> oIterador = alColumnsNames.listIterator();
    String strNombreMantenimiento = "usutarea";
%>
