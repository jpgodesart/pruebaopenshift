...
function buildDataTable(cabecera, campos, datos) {
    ...
    $.each(datos['list'], function(index, value) {
        ...
        tabla += '<a class="btn btn-mini action01" id=' + value.id + ' href="#"><i class="icon-eye-open icon-white"></i></a>';
        tabla += '<a class="btn btn-mini action02" id=' + value.id + ' href="#"><i class="icon-zoom-in icon-white"></i></a>';
        tabla += '<a class="btn btn-mini action03" id=' + value.id + ' href="#"><i class="icon-pencil icon-white"></i></a>';
        tabla += '<a class="btn btn-mini action04" id=' + value.id + ' href="#"><i class="icon-remove icon-white"></i></a>';
        tabla += '</div></div></td>';
        tabla += '</tr>';
    });
    tabla += "</table>";
